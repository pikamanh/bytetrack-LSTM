...
ln -s ../crowdhuman/train crowdhuman_train
ln -s ../crowdhuman/val crowdhuman_val
ln -s ../Citypersons cp_train
...
cp_json = json.load(open('datasets/Citypersons/annotations/train.json','r'))
img_id_count = 0
